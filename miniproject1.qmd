...
Highlighted expressions (commented in the code as well) - str\_ function: 1 to turn all of the text lowercase to be consistent - str\_ function 2 to count the words with str_count, following the calculation to calculate character mentions every 1000 words - str\_ function 3 (later on in the project): str_length filters out short tokens (a, or) - Regular Expression 1: Different versions of Voldemort's and Ron's names where I used \b for word boundaries - Regular Expression 2: Here I used \b word boundary matching for the other characters - Regular Expression 3: this matches any complete word
